...
namespace EntityFrameworkExtras.Tests.Integration.StoredProcedures
{
    ...
    public class ParameterDirectionStoredProcedure
    {
        ...
        [StoredProcedureParameter(SqlDbType.NVarChar, Direction = ParameterDirection.InputOutput, Size = 100)]
        public String ParameterDirectionInputOutput { get; set; }

        [StoredProcedureParameter(SqlDbType.NVarChar, Direction = ParameterDirection.Output, Size = 100)]
