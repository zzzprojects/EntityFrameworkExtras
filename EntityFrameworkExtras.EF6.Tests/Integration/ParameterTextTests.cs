...
{
    [TestFixture]
    public class ParameterTextTests : DatabaseIntegrationTests
    {
        ...
        public void Parameter_Execute_NoErrors()
        {
            ...
            procedure.ParameterText = "Michael";
        ...
        public void Parameter_Execute_CorrectValueSet()
        {
            ...
            Assert.AreEqual("michael", result.ParameterText);
        }
    }
}